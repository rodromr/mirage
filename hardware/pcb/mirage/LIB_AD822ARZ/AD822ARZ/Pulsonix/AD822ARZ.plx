...
//165463/1234278/2.50/8/3/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "AD822ARZ" (originalName "AD822ARZ")
	...
	(compDef "AD822ARZ" (originalName "AD822ARZ") (compHeader (numPins 8) (numParts 1) (refDesPrefix IC)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "AD822ARZ"))
		...
		(attr "Mouser Part Number" "584-AD822ARZ")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Analog-Devices/AD822ARZ?qs=%2FtpEQrCGXCyQk45j94GovQ%3D%3D")
		(attr "Manufacturer_Name" "Analog Devices")
		(attr "Manufacturer_Part_Number" "AD822ARZ")
		(attr "Description" "Dual low power op amp,AD822AR SO8")
		(attr "<Hyperlink>" "https://www.analog.com/media/en/technical-documentation/data-sheets/AD822.pdf")
		(attr "<Component Height>" "1.75")
		(attr "<STEP Filename>" "AD822ARZ.stp")
